      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="space-y-4 sm:space-y-6 order-2 lg:order-1">
            ...
            {/* Story Text */}
            <div className="space-y-3 sm:space-y-4 text-white/60 text-sm leading-relaxed">
              <p>
          ...
          <div className="relative order-1 lg:order-2">
            ...
            {/* Decorative border - Hidden on small mobile */}
            <div className="hidden sm:block absolute -bottom-4 -right-4 w-full h-full border-2 border-[#FF5A1F]/20 rounded-lg -z-10" />
          </div>
        </div>
      </div>
    </section>
