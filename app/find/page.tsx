    ...
    <main className="min-h-screen bg-[#0a0a0a]">
      ...
      <div className="pt-16">
        <div className="flex flex-col lg:flex-row min-h-[calc(100vh-64px)]">
          ...
          <div className="lg:w-1/2 h-[400px] lg:h-auto relative bg-[#141414]">
            <iframe
              src={mapEmbedUrl}
              width="100%"
              height="100%"
            ...
            {/* Map overlay badge */}
            <div className="absolute top-4 left-4 px-4 py-2 bg-[#FF5A1F] rounded shadow-lg">
              <span className="text-white text-xs font-bold tracking-wider">WE'RE HERE!</span>
            </div>
          </div>

          {/* Right Section - Location Info */}
          <div className="w-full lg:w-1/2 bg-[#0a0a0a] p-8 lg:p-16">
            <div className="max-w-lg mx-auto">
              ...
              <div className="mb-10">
                ...
                <h1 className="font-[var(--font-oswald)] text-4xl font-bold text-white mt-2">
                  MUNCH PIT
                </h1>
              ...
              <Link
                ...
                className="flex items-center justify-center gap-2 w-full py-4 bg-[#00FF00] text-black font-bold text-sm tracking-wider rounded hover:bg-[#00cc00] transition-all duration-200"
              >
              ...
              <Link
                href="/menu"
                className="flex items-center justify-center gap-2 w-full py-4 mt-3 bg-[#1a1a1a] border border-[#2a2a2a] text-white font-semibold text-sm tracking-wider rounded hover:bg-[#2a2a2a] hover:border-[#333] transition-all duration-200"
              >
                VIEW MENU
                <ChevronRight className="w-4 h-4" />
              </Link>
