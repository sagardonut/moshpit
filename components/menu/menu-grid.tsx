...
export function MenuGrid({ activeCategory, onAddToCart }: MenuGridProps) {
  ...
  return (
    <div className="flex-1 min-h-[calc(100vh-64px)] bg-[#141414] p-8 overflow-y-auto">
      {categories
          ...
          return (
            <section key={category} className="mb-12" id={category}>
              ...
              <div className="flex items-center gap-4 mb-6">
                <h2 className="font-[var(--font-oswald)] text-2xl font-bold text-white">
                  {getCategoryLabel(category)}
                </h2>
                <div className="flex-1 h-px bg-[#2a2a2a]" />
                {category === "limited" && (
                  <span className="text-[#FF5A1F] text-xs font-semibold tracking-wider animate-pulse">
                    LIMITED TIME
                  </span>
                )}
              </div>
                    ...
                    <div className="flex">
                      ...
                      <div className="flex-1 p-5 flex flex-col">
                        <div className="flex items-start justify-between gap-2 mb-2">
                          <h3 className="font-[var(--font-oswald)] text-base font-semibold text-white tracking-wide">
                            {item.name}
                          </h3>
                          <span className="text-[#FF5A1F] font-bold text-lg shrink-0">
                            ${item.price}
                          </span>
                        </div>
                        
                        <p className="text-white/50 text-xs mb-4 flex-1 line-clamp-2">
                          {item.description}
                        </p>
                        ...
                        <button 
                          ...
                          className="flex items-center justify-center gap-2 px-4 py-2 bg-[#2a2a2a] border border-[#333] text-white text-xs font-semibold tracking-wider rounded hover:bg-[#FF5A1F] hover:border-[#FF5A1F] transition-all duration-200"
                        >
