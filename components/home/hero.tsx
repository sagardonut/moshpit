      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            {/* Badge */}
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#FF5A1F] rounded">
            ...
            <div className="space-y-2">
              <h1 className="font-[var(--font-oswald)] text-5xl sm:text-6xl lg:text-7xl font-bold text-white leading-[0.95] tracking-tight">
                WE'RE HERE
              </h1>
              <h1 className="font-[var(--font-oswald)] text-5xl sm:text-6xl lg:text-7xl font-bold leading-[0.95] tracking-tight">
            ...
            <div className="flex flex-wrap items-center gap-4">
              <Link
                href="/menu"
                className="inline-flex items-center gap-2 px-6 py-3.5 bg-[#00FF00] text-black text-sm font-bold tracking-wider rounded hover:bg-[#00cc00] transition-all duration-200"
              >
                ORDER NOW
              </Link>
              <Link
                href="/find"
                className="inline-flex items-center gap-2 px-6 py-3.5 bg-[#1a1a1a] border border-[#333] text-white text-sm font-semibold tracking-wider rounded hover:bg-[#2a2a2a] hover:border-[#444] transition-all duration-200"
              >
